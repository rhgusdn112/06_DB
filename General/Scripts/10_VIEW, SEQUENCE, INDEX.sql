...
VALUES('D0', 'L2');
--> 가상의 테이블 VIEW인데 INSERT가 성공함!!

-- INSERT 결과 확인 - V_DCOPY2  VIEW
SELECT * FROM V_DCOPY2;
-- D0	L2

-- INSERT 결과 확인 - DEPT_COPY2  원본 테이블
...
CREATE TABLE TB_IDX_TEST(
	TEST_NO NUMBER PRIMARY KEY, -- 자동으로 UNIQE INDEX 생성됨
...
WHERE TEST_ID = 'TEST500000'; -- 0.012

/* 인덱스 O */
-- TEST_NO가 500000인 행 조회

SELECT * FROM TB_IDX_TEST
WHERE TEST_NO = 500000; -- 0.000
--> 17배 차이(보통 10~30배 차이)
