...
/* TEST_USER 계정에는
 * 데이터베이스 접속 권한인 CREATE SESSION만 부여됨.
 * 
...
SELECT * FROM KH_GHW.EMPLOYEE;

-- 다른 테이블 조회도 되는지 확인
SELECT * FROM KH_GHW.DEPARTMENT;
...
SELECT * FROM KH_GHW.EMPLOYEE; -- 조회불가해야하는데 나옴
